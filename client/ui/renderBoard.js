...
export function renderBoard(dependencies = {}) {
  ...
  const mergeSelecting = dependencies.mergeSelecting || false
  const candidateHighlights = dependencies.candidateHighlights || new Set()
  const hintMove = dependencies.hintMove || null
  const longPressTimer = dependencies.longPressTimer || null
  const bossShatterSelecting = dependencies.bossShatterSelecting || false
